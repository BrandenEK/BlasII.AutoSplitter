...
state("Blasphemous 2", "1.0.5")
{
    ...
    uint   mainRoom1 : "GameAssembly.dll", 0x336A6F0, 0xB8, 0x538, 0x30, 0x0;
    uint   mainRoom2 : 0;
...
state("Blasphemous 2", "1.1.0")
{
    ...
    uint   mainRoom1 : "GameAssembly.dll", 0x33A63D8, 0xB8, 0x3C0, 0x250, 0x30, 0x0;
    uint   mainRoom2 : 0;
...
state("Blasphemous 2", "2.1.1")
{
    ...
    uint   mainRoom1 : "GameAssembly.dll", 0x39C4120, 0xB8, 0x5C8, 0x30, 0x0;
    uint   mainRoom2 : 0;
