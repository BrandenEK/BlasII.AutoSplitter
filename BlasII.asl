...
state("Blasphemous 2", "1.0.5")
{
    ...
    bool       isInputLocked : "GameAssembly.dll", 0x336A6F0, 0xB8,  0x408, 0xB8,  0x78;
    float    playerPositionX : "GameAssembly.dll", 0x336A6F0, 0xB8,  0xE0,  0x38,  0x60,  0x48,  0xDC;
}

state("Blasphemous 2", "GOG 1.0.5")
{
    bool           isPlaying : "GameAssembly.dll", 0x32F2028, 0xB8,  0xE0,  0x30,  0x190;
    uint           earlyRoom : "GameAssembly.dll", 0x32F2028, 0xB8,  0x270, 0x20,  0x14;
    uint            mainRoom : "GameAssembly.dll", 0x32F2028, 0xB8,  0x2D0, 0x28,  0x0;
    uint            lateRoom : "GameAssembly.dll", 0x32F2028, 0xB8,  0x3C8, 0x150, 0x70;
    int           bossHealth : "GameAssembly.dll", 0x32F2028, 0xB8,  0x98,  0x2B0, 0xD0,  0xC0,  0x598, 0x38,  0x30;
    int         lesmesHealth : "GameAssembly.dll", 0x32F2028, 0xB8,  0x98,  0x2B0, 0xD0,  0xC0,  0x598, 0x38,  0x50;
    int        infantaHealth : "GameAssembly.dll", 0x32F2028, 0xB8,  0x98,  0x2B0, 0xD0,  0xC0,  0x598, 0x38,  0x70;
    int         playerHealth : "GameAssembly.dll", 0x32F2028, 0xB8,  0x1E8, 0x18,  0x20,  0x30,  0x90,  0x18,  0x120, 0x98;
    bool       isInputLocked : "GameAssembly.dll", 0x32F2028, 0xB8,  0x468, 0xB0,  0x78;
    float    playerPositionX : "GameAssembly.dll", 0x32F2028, 0xB8,  0xE0,  0x38,  0x60,  0x48,  0xDC;
}
...
{   
    ...
    switch (size)
    {
        ...
        case 62291968:  version = "GOG 1.0.5"; break;
