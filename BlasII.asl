...
split
{
    if (settings["B_" + current.mainRoom] && !vars.bossesKilled.Contains(current.mainRoom))
    {
        ...
        bool standard = current.bossHealth == 0 && old.bossHealth != 0 && current.mainRoom != 0x07B20A5A && characterHealth != 0;
        bool eviterno = current.bossHealth == 0 && old.bossHealth != 0 && current.mainRoom == 0x9AB9D533 && characterHealth != 0;
        ...
        bool lesmes = current.lesmesHealth == 0 && current.infantaHealth == 0 && (old.lesmesHealth != 0 || old.infantaHealth != 0) && characterHealth != 0;
